...
class TestEnv(AirSimDroneEnv):
    ...
    def compute_reward(self):
        ...
        if self.test_mode == "sequential":
            total_holes = 15
            if (agent_traveled_x+0.3)/4 > total_holes:
                done = 1
            ...
            if done:
                ...
                print("> Holes reached (mean): %d out of %d" % (int(mean_traveled//4), total_holes))
                print("-----------------------------------\n")
